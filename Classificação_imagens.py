...
data = tf.keras.utils.image_dataset_from_directory('imagens') #batch_size=32, image_size=(256, 256), shuffle=True, seed=123, validation_split=0.2, subset="training", interpolation="bilinear", follow_links=False
